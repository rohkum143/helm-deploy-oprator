...
import (
	...
	sigs_k8s_io_controller_runtime_scheme "sigs.k8s.io/controller-runtime/pkg/scheme"
)
...
var (
	...
	SchemeBuilder = &sigs_k8s_io_controller_runtime_scheme.Builder{GroupVersion: GroupVersion}
